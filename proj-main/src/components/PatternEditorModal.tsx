...
export const PatternEditorModal: React.FC<PatternEditorModalProps> = ({
  ...
  const [canonicalUrl, setCanonicalUrl] = useState<string>(
    initialPattern?.seoMeta?.canonicalUrl || (initialPattern ? `https://crochethub.com/pattern/${initialPattern.slug}` : '')
  );
        ...
        try {
          ...
          if (data && data.success && data.pattern) {
            ...
            if (p.title) {
              ...
              setCanonicalUrl(`https://crochethub.com/pattern/${slug}`);
            }
          } else {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    const seoMetaObj: SeoMeta = {
      ...
      canonicalUrl: canonicalUrl || `https://crochethub.com/pattern/${slug}`,
      ogType: 'article',
        ...
        <form onSubmit={handleSave} className="p-6 overflow-y-auto space-y-6 flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5 md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Daisy Granny Square Blanket - Free Crochet Pattern | CrochetHub"
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="https://crochethub.com/pattern/my-pattern-slug"
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs focus:ring-2 focus:ring-[#E96BA8]"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1.5">
                    <div className="flex items-center gap-1.5 text-[11px] text-slate-500 font-sans">
                      ...
                      <span className="text-slate-700 dark:text-slate-300">crochethub.com</span>
                    ...
                    <h5 className="text-sm font-semibold text-blue-700 dark:text-blue-400 hover:underline cursor-pointer truncate">
                      {metaTitle || (title ? `${title} - Free Crochet Pattern | CrochetHub` : 'Pattern Title - Free Crochet Pattern')}
                    </h5>
                  ...
                  <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-800 overflow-hidden shadow-2xs">
                    ...
                    <div className="p-3 bg-slate-50 dark:bg-slate-800/90 border-t border-slate-100 dark:border-slate-700/50">
                      <span className="text-[10px] uppercase font-bold text-slate-400">CROCHETHUB.COM</span>
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
            <div className="flex items-center gap-2">
              {savedSuccess ? (
                ...
                <span className="text-xs text-slate-500">
                  Saving automatically applies dynamic SEO meta tags to document head
                </span>
              )}
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl bg-[#E96BA8] hover:bg-pink-600 text-white text-xs font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 cursor-pointer"
              >
                <Check className="w-4 h-4" />
