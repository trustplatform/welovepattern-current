...
export const getToolSeoData = (slug: string, toolTitle: string, category: string, description: string): ToolSeoData => {
  const canonicalUrl = `https://crochethub.com/tools/${slug}`;
  
  let metaTitle = `${toolTitle} - Free Online Crochet & Craft Tool | CrochetHub`;
  ...
  if (slug === 'row-counter') {
    metaTitle = 'Free Online Crochet Row Counter - Digital Stitch & Row Tracker | CrochetHub';
    ...
    metaTitle = 'Crochet Gauge Swatch Calculator - Compare Stitches & Rows | CrochetHub';
    ...
    metaTitle = 'Yarn Yardage & Meter Calculator for Blankets, Sweaters & Toys | CrochetHub';
    ...
    metaTitle = 'Crochet Hook Size Converter - Metric (mm) vs US Letter vs UK | CrochetHub';
    ...
    metaTitle = 'Crochet Selling Price Calculator - Fair Craft Retail Pricing | CrochetHub';
    ...
    metaTitle = 'Crochet Abbreviation Dictionary - US vs UK Stitch Glossary | CrochetHub';
...
<meta property="og:image" content="https://crochethub.com/og-tools.jpg">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white text-slate-900 p-4 sm:p-5 rounded-2xl shadow-md border border-slate-200 font-sans space-y-1.5">
                <div className="flex items-center gap-2 text-xs text-slate-600">
                  ...
                  <span className="text-slate-700 font-medium truncate">CrochetHub</span>
