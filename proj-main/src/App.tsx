...
export default function App({ initialPath, initialBlogPosts, initialCategories, initialPatternSeoArticles, initialSitePages }: AppProps) {
  ...
  const [patterns, setPatterns] = useState<Pattern[]>(PATTERNS_DATA);
  ...
  // Load public categories, published pattern SEO articles, and site pages from server API if available
  useEffect(() => {
